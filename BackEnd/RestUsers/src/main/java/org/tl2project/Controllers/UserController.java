		package org.tl2project.Controllers;
...
import org.tl2project.Services.UserService;
...
public class UserController {
		...
		public ResponseEntity<String>  register(@RequestParam(value="username") String username,@RequestParam(value="email") String email,@RequestParam(value="password") String password){
