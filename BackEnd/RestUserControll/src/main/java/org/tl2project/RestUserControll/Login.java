...
//Path: http://localhost/RestUserController/webapi/login
@Path("/login")
public class Login {
	// HTTP Get Method
	@GET 
	// Path: http://localhost/RestUserController/webapi/login/dologin
	@Path("/dologin")
	// Produces JSON as response
	@Produces(MediaType.APPLICATION_JSON) 
	// Query parameters are parameters: http://localhost/RestUserController/webapi/login/dologin?username=abc&password=xyz
